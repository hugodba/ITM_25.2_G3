...
class VoltageSourceDC(Element, prefix='vdc'):
    """Classe representando uma Fonte de Tensão (DC)."""

    elem_type = "invariant"
    elem_name = "Fonte de Tensão DC"
    ...
    def extract_values(self, splitline_netlist):
        try:
            ...
            self.V = float(splitline_netlist[4])
